          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-gray-50 border-gray-200 rounded-xl text-sm text-gray-900 placeholder-gray-400  focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition"
